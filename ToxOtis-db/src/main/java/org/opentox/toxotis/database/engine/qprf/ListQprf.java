 ...
 */
public class ListQprf extends DbReader<String>{

    private PreparedStatement statement = null;
    private org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(ListQprf.class);


    @Override
    public IDbIterator<String> list() throws DbException {
        setTable("QprfReport");
        setTableColumns("QprfReport.id");
        try {
            ...
            final String msg = "Error reading Qprf Report id from the database";
            logger.warn(msg, ex);
