...
We can publish a bibliographic reference as we did with features. Here is an example where a BibTeX object "(doc)":http://opentox.ntua.gr/toxotis/javadoc/org/opentox/toxotis/core/BibTeX.html is created and published online:
