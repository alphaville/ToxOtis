...
<b>Version:</b>
 + "0.4.3.2":https://opentox.ntua.gr/dev/toxotis/0.4.3.2/, official alpha version. 
...
h2. Download
  ...
  You can download the source code of ToxOtis from github either in zip or tar.gz format (click on the "Downloads" button). The jar and javadoc files are found online at "https://opentox.ntua.gr/dev/toxotis":https://opentox.ntua.gr/dev/toxotis and are regularly updated. Download the latest version of ToxOtis from that repository; To get the necessary libraries (jar files) you can either read the "Dependencies" section below or easier download what you need from "https://opentox.ntua.gr/dev/toxotis/external_libs":https://opentox.ntua.gr/dev/toxotis/external_libs/ : Download the file 'ToxOtisLibs.zip' unzip it and add all jar files in your classpath.
...
If you wish, you can download the full set of dependencies (jar files only) from our online repository at "https://opentox.ntua.gr/dev/toxotis/external_libs":https://opentox.ntua.gr/dev/toxotis/external_libs/ and add all jar files in your classpath. All licenses are included in the "/Licenses":https://github.com/alphaville/ToxOtis/tree/master/Licenses directory of this project.
...
Beta release of ToxOtis has been scheduled for January 15, 2011!
