...
h3. With Ant
   ...
   If you prefer the ant-based ToxOtis the build.xml files are also distributed along with the source code. Alternatively run <code>mvn ant:ant</code> and create your own XML files for ant. Alternatively, you can download the latest version from the nexus repository and add it to your classpath.
